from clean_code.flexible_bitter_llm import FlexibleBitterLLM, off_policy_flexible_training_step, ExactRandomGater
...
with profile(
    ...
    for i in range(20):
        ...
        with record_function("training_step"):
            off_policy_flexible_training_step(my_model, input_ids, my_optimizer, loss_mask, my_scheduler, None, learning_gating=False)
