"""
After decent results with experiment 31, let's see if some of the tokenization strategy was the result of greed.
"""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Experiment 32 for bitter tokenization")
    ...
    discount_rate = seed_to_discount_rate[args.seed]
    ...
    training_loop_kwargs = {
        ...
        "relative_gating_loss_weight": 0.1*(1 - discount_rate),
    ...
    train_losses_file = os.path.join(net_scratch_dir, f"experiment_32/train_losses_{args.seed}.csv")
    train_losses.to_csv(train_losses_file, index=False)
    print(f"Train losses saved to {train_losses_file}")


    model_file_name = f"experiment_32/model_{args.seed}.pt"
