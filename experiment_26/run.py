"""
Experiment 25: like experiment_24 with warm starting as well. 
Results: a bit dissapointing. The learned downsample rate is very high, but the model is collapsing gating.
"""
...
if __name__ == "__main__":
    ...
    train_losses_file = os.path.join(net_scratch_dir, f"experiment_26/train_losses_exp26_{args.seed}.csv")
    train_losses.to_csv(train_losses_file, index=False)
    print(f"Train losses saved to {train_losses_file}")

    model_file_name = f"experiment_26/bitter-llm-exp26_{args.seed}.pt"
