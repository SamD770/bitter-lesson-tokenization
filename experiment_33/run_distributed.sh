...
#SBATCH --output=experiment_33/logs/log_%A_%a.out
#SBATCH --error=experiment_33/logs/errors_%A_%a.err
#SBATCH --array=42
...
apptainer exec --nv --bind /itet-stor/sdauncey/net_scratch:/itet-stor/sdauncey/net_scratch,/scratch/sdauncey:/scratch/sdauncey /scratch/sdauncey/sams_favorite_build.sif bash experiment_33/launch_distributed.sh $SEED
