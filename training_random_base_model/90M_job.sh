#!/bin/bash
#SBATCH --job-name=90M_run
#SBATCH --output=training_random_base_model/logs/90M_%A_%a.out
#SBATCH --error=training_random_base_model/logs/90M_%A_%a.err
...
apptainer exec --nv --bind \
 ...
 bash training_random_base_model/launch_distributed.sh 90M 8 $UPDOWN_SAMPLER 42
