...
if __name__ == "__main__":
    ...
    train_losses_file = os.path.join(net_scratch_dir, f"training_random_base_model/random_select_early_output_base_model_{args.seed}.csv")
    train_losses.to_csv(train_losses_file, index=False)
    print(f"Train losses saved to {train_losses_file}")

    model_file_name = f"training_random_base_model/random_select_early_output_base_model_{args.seed}.pt"
