...
def main():
    ...
    model_kwargs["GaterClass"] = ExactRandomGater
    model_kwargs["flash_attn"] = True # Keep for ExactRandomGater
    ...
    training_loop_kwargs["early_output_loss_weight"] = 0.2 # Keep for ExactRandomGater
